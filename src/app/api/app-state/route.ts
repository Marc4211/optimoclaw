 ...
 * GET /api/app-state
 *
 * Returns the full OptimoClaw app state as JSON for agent consumption.
 *
 ...
 *   2. window.__OPTIMOCLAW_STATE__ (injected by AppStateProvider)
 *
...
export async function GET() {
  return NextResponse.json({
    ...
    instructions: {
      ...
      js: "Access window.__OPTIMOCLAW_STATE__ for full JSON state object.",
      pages: {
